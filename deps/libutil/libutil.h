...
typedef bool predicate_t(void *el, size_t index, array_t *array, void *compare_to);
 ...
 */
bool buffer_slice(buffer_t *self, size_t start, size_t end_inclusive, char *dest);
 ...
 */
io_write_all_result io_write_all(FILE *fd, const char *data, size_t *n_write_ptr);
