...
bool
int_comparator (int a, int b) {
  return a == b;
}

bool
str_comparator (char *a, char *b) {
  return s_equals(a, b);
}

size_t
array_size (array_t *self) {
  return ((__array_t *)self)->size;
}

void *
array_get (array_t *self, ssize_t index) {
...
bool
array_includes (array_t *self, comparator_t *comparator, void *compare_to) {
  __array_t *unwrapped = (__array_t *)self;
...
ssize_t
array_find (array_t *self, comparator_t *comparator, void *compare_to) {
  __array_t *unwrapped = (__array_t *)self;
...
bool
array_push (array_t *self, void *el) {
  __array_t *unwrapped = (__array_t *)self;

  if (unwrapped->size == unwrapped->capacity) {
    void **next_state = realloc(unwrapped->state, (unwrapped->size + LIB_UTIL_ARRAY_CAPACITY_INCR) * sizeof(void *));
    if (!next_state) {
      free(next_state);
      errno = ENOMEM;
...
bool
array_insert (array_t *self, size_t index, void *el, free_fn *free_old_el) {
  __array_t *unwrapped = (__array_t *)self;
...
array_t *
array_slice (array_t *self, size_t start, ssize_t end) {
  __array_t *unwrapped  = (__array_t *)self;
...
bool
array_remove (array_t *self, size_t index) {
  __array_t *unwrapped = (__array_t *)self;
...
array_t *
array_map (array_t *self, callback_t *callback) {
  __array_t *unwrapped = (__array_t *)self;
...
array_t *
array_filter (array_t *self, predicate_t *predicate, void *compare_to) {
  __array_t *unwrapped = (__array_t *)self;
...
void
array_foreach (array_t *self, callback_t *callback) {
  __array_t *unwrapped = (__array_t *)self;
...
array_t *
array_concat (array_t *arr1, array_t *arr2) {
  __array_t *internal1 = (__array_t *)arr1;
  __array_t *internal2 = (__array_t *)arr2;

  __array_t *result    = (__array_t *)array_init();

  result->state = realloc(result->state, (internal1->size + internal2->size) * sizeof(void *));
  if (!result->state) {
    errno = ENOMEM;
    return NULL;
  }
  ...
  memcpy(result->state + internal1->size, internal2->state, internal2->size * sizeof(void *));

  return (array_t *)result;
}

void
array_free (array_t *self, free_fn *free_fnptr) {
  __array_t *unwrapped = (__array_t *)self;
  if (free_fnptr) {
    foreach (self, i) {
